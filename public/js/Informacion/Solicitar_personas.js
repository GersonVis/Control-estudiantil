...
solicitar_personas = function (url, contenedor_respuesta, cuantos = 5, desde_donde = 0) {
    ...
    var accion_seleccionada="solicitud_personas"
    var function_solicitud={
        ...
        busqueda: async function(desde_donde, cuantos){
            return enviar_formulario(url,
               {
                   Posicion_limite: desde_donde,
                   Numero_registros: cuantos
    ...
    this.solicitar_datos = async function solicitar_datos() {
        ...
        en_uso = true
        var personas = await function_solicitud[accion_seleccionada](desde_donde, cuantos)
