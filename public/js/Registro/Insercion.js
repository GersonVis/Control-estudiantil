...
<div class="w-100 h-75 d-flex ">
    <div class="d-flex h-100 w-75 flex-column justify-content-center">
        ...
        <p class="texto-label  text-secondary m-0">${lugar}</p>
    </div>
    <div class="botob-eliminar d-flex  w-25 h-100 justify-content-center align-items-center">
        <div onclick="accion_salida('${id}', '${no_control}')" no-control="${no_control}" style="border-radius: 50% 50%; width: 30px; height: 30px" class="d-flex justify-content-center align-items-center">
